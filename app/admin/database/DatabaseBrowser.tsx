...
import { Edit2, Trash2, RefreshCw, Search, ChevronLeft, ChevronRight, Save, X, AlertTriangle } from 'lucide-react'
...
export default function DatabaseBrowser() {
  ...
  const load = useCallback(async () => {
    ...
    if (res.ok) {
      const d = await res.json()
      setRows(d.rows); setFields(d.fields); setEditFields(d.editFields); setTotal(d.total)
    }
    setLoading(false)
  }, [model, page, q])
